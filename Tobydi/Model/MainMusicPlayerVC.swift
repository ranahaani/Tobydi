...
class MainMusicPlayerVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func reload() {
        let jsonUrlString =
        "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=20&q=Music&key=AIzaSyCSP3HUsmcAPSnUAS877Jac9QzDABnH6NY"
            ...
            do {
                ...
                for sng in songs.items {
                    if(sng.id.videoId==nil){
                        self.video_arr.append("K1O9Dj0GLos")
                        self.images.append("https://i.ytimg.com/vi/ZRkdyjJ_MdM/hqdefault.jpg")
                    }else{
